...
def test_get_url():
    ...
    assert (
        get_url(url)
        == "http://gateway.btfs.io/btfs/QmZSQtptpUV17dmQQTGakbhU22MUxMJYCUq6MjjVm1C1Gb/612.json"
    )
    ...
    assert (
        get_url(url)
        == "https://gateway.pinata.cloud/ipfs/bafybeic2a7jdsztni6jsnq2oarb3o5g7iuya5r4lcjfqi64rsucirdfobm/5"
    )
...
def test_get_image_url():
    ...
    assert (
        get_url(url, True)
        == "https://gateway.pinata.cloud/ipfs/bafybeiaf6ppnztlf3k5edqrgq3zae5ih2y6vhf255hekkqn6vjwazhq36q/WHITE/flameling_white_4.png"
    )
